...
- Live `alanedb` Supabase project connected; eight production migrations deployed and verified
...
- Remaining registration, people, and finance write workflows are next; final-domain DNS and Resend configuration are reserved for the last launch step
