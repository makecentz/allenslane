...
- Guarded customer household workflow for profile, home-address, and non-login participant creation/editing, with direct browser mutations revoked and audit events recorded
...
- `supabase/migrations/20260806182153_customer_household_workflows.sql` — guarded customer household/profile/address/participant workflows, direct-write revocation, and identity audit coverage
